...
const _face = new THREE__namespace.Triangle();
const _color = new THREE__namespace.Vector3();
const _uva = new THREE__namespace.Vector2(), _uvb = new THREE__namespace.Vector2(), _uvc = new THREE__namespace.Vector2();
/**
...
class MeshSurfaceSampler {
    ...
    _sampleFaceIndex() {
        if (this.distribution === null) {
            throw new Error("MeshSurfaceSampler: build() must be called before sampling.");
        }
