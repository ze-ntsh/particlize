...
import { O as OriginRestoringForce } from '../../OriginRestoringForce-D-KMxY5y.js';
...
class BasicConstraintsPlugin {
    ...
    onInit(system) {
        // Lifetime update
        const lifetimeUpdate = new Constraint("lifetimeUpdateConstraint", 
        /*glsl*/ `
      if (lifetime > 0.0) {
        lifetime -= u_delta;
      }
    `);
        // Lifetime discard
        const lifetimeDiscard = new Constraint("lifetimeDiscardConstraint", 
        /*glsl*/ `
    ...
    `);
        ...
        const colorFadeOnLifetime = new Constraint("colorLifetimeConstraint", 
        /*glsl*/ `
    ...
    `);
        ...
        const velocityUpdate = new Constraint("velocityUpdateConstraint", 
        /*glsl*/ `
    ...
    `);
        ...
        const positionUpdate = new Constraint("positionUpdateConstraint", 
        /*glsl*/ `
